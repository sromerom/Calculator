...
public class Polynomial {
    ...
    public Calculs.Polynomial add(Calculs.Polynomial p) {
        //this.coe
        ...
        Calculs.Polynomial resultatSum = new Calculs.Polynomial(NewCoeSum);

        return resultatSum;
    }

    // Multiplica el polinomi amb un altre. No modifica el polinomi actual (this). Genera un de nou
    public Calculs.Polynomial mult(Calculs.Polynomial p2) {
        ...
        Calculs.Polynomial resultatMul = new Calculs.Polynomial(NewCoeMul);
    ...
    public Calculs.Polynomial[] div(Calculs.Polynomial p2) {
        return null;
    }
    ...
    public boolean equals(Object o) {
        Calculs.Polynomial p = (Calculs.Polynomial) o;
